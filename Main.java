...
public class Main {
    ...
    private static OutputNode synth() {
        /*
        double freqV = Frequency.toVOct("F4");
        double freqIV = Frequency.toVOct("Eb4");
        double freqiii = Frequency.toVOct("Db4");
        double freqI = Frequency.toVOct("Bb3");
        ...
        Module noise = new Oscillator(Oscillator.Shape.SINE, seq.get());
        Module mix = new Mixer(0.3, noise.get());
        return mix.get();
        */
            Module clock = new Oscillator(Oscillator.Shape.SQUARE, Frequency.toVOct(Time.TEMPO_HZ));
            ...
            Module bass = new Oscillator(Oscillator.Shape.SQUARE, slew.get(), new ConstNode(0.08), new ConstNode(0));
            Module pad0 = new Oscillator(Oscillator.Shape.SINE, Frequency.toVOct("G4"), 0.1, 0);
            Module pad1 = new Oscillator(Oscillator.Shape.SINE, Frequency.toVOct("A4"), 0.1, 0);
            Module pad2 = new Oscillator(Oscillator.Shape.SINE, Frequency.toVOct("D5"), 0.1, 0);
            Module noise = new Noise();
            Module lpf = new LPF(noise.get(), 500, 301, Filter.Window.RECTANGULAR);
            Module saw = new Oscillator(Oscillator.Shape.SAWTOOTH, Frequency.toVOct(Time.TEMPO_HZ), -0.5, 0.5);
