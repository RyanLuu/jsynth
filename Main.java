...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            Module bass = new Oscillator(Oscillator.Type.SAWTOOTH, slew.get(), new ConstNode(0.2), new ConstNode(0));
            ...
            Module mix = new Mixer(bass.get(), pad0.get(), pad1.get(), pad2.get(), vca.get());
            for (int i = 0; i < Time.LENGTH; i++) {
                double sample = mix.get().update(i).get();
